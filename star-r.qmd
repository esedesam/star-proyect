...
def run_dml_analysis(data, y_col, d_cols, ml_l_rf, ml_l_xgb, ml_m_rf, ml_m_xgb,seed, varGATE = None, grupos=None, curso=None, n_folds=10, show_summary=False):
...
Parece que los grupos no caucásicos se benefician en mayor medida del hecho de estar en clases más reducidas, el único curso donde el efecto tratamiento no muestra diferencias amplias es en el primer curso, como se observa en el gráfico.
...
En este caso observamos que las mujeres se habrían beneficiado más del tratamiento que los hombres, sin embargo en kindergarten, que es cuando los niños entran en el sistema educativo, serían los hombres los que se beneficiarian más que las mujeres, al igual que en segundo pero de forma muy ligera. En el resto de cursos son las mujeres las que perciben mayor efecto tratamiento.
