...
```{python hist-respuesta-tratamiento, fig.cap="<strong>Figura 32. </strong> Distribución de la respuesta por estatus de tratamiento (clase regular vs clase reducida)", echo=TRUE}
