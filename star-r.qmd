...
Por otra parte, escogemos como variable de respuesta una nueva variable **nota**, definida como la suma de las puntuaciones en lectura y matemáticas, habitual en la literatura relacionada con este estudio.
...
Según la documentación del estudio, tanto la asignación de alumnos como de profesores fue totalmente aleatoria, por lo que podemos tomar el DIM como una primera estimación válida del AET con la que comparar el resto de estimaciones que realizaremos más adelante.
