...
Las columnas de los Modelos 2 a 5 muestran que la inclusión de variables adicionales de índole estudiantil, docente y escolar no han modificado drásticamente el valor de la estimación del efecto del tratamiento. Continuamos teniendo un valor positivo y significativo para el efecto de la clase pequeña en el rendimiento de los estudiantes, en contraposición al que otorga la ayuda en la clase regular que no es significativo.
...
def run_dml_analysis(data, y_col, d_cols, ml_l_rf, ml_l_xgb, ml_m_rf, ml_m_xgb, grupos=None, curso=None, n_folds=10, show_summary=True):
    ...
    dml_data = DoubleMLData(data, y_col=y_col, d_cols=d_cols, x_cols = None)
