...
Por tanto, el estudio de los datos del proyecto *STAR* nos permite afirmar que la pertenencia a clases de tamaño reducido resulta en un efecto positivo sobre las puntuaciones de los estudiantes en todos los cursos, especialmente en Kindergarten, respecto a las clases normales. Además, observamos la existencia de algunos grupos heterogéneos para las variables confusoras más relevantes que implican que ciertos grupos de estudiantes se vieron beneficiados por un mayor efecto.
