...
## Aplicación ténicas de matching
...
Observamos que, en todos los casos, el efecto causal se reduce respecto a la previa obtención del ATE con los modelos lineales sin usar matching. Esta ligera reducción puede deberse a la consideración de variables de confusión en el tratameinto. Dado que está mejor identificado el efecto causal, esta estimación debería ser más fiable.
