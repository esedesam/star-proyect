...
p_load(AER, ggplot2, ggthemes, dplyr, tidyr, knitr, stargazer, sandwich, GGally, stringr, vcd, MatchIt, cobalt, marginaleffects)
...
modelo_match_k <- glm(stark ~ markK*(experiencek + lunchk + schoolk + gender +  ethnicity_grouped),
                      data=star_k_match_data,family = quasibinomial(),
                      weights = weights)
pred.gformula <- predictions(modelo_match_k,
                      variables = "markK", # variable para la que generar contrafactuales
                      vcov = ~subclass,   # estimacion robusta de se
                      newdata = star_k_match_data, # ATE
                      wts = "weights",
                      by="markK") # variable de agregación
pred.gformula

avg_comparisons(modelo_match_k,variables = "markK",
                      vcov = ~subclass,   # estimacion robusta de se
...
modelo_match_1 <- glm(star1 ~ mark1*(experience1 + lunch1 + school1 + gender +  ethnicity_grouped),
                      data=star_1_match_data,family = quasibinomial(),
                      weights = weights)
pred.gformula <- predictions(modelo_match_1,
                      variables = "mark1", # variable para la que generar contrafactuales
                      vcov = ~subclass,   # estimacion robusta de se
                      newdata = star_1_match_data, # ATE
                      wts = "weights",
                      by="mark1") # variable de agregación

pred.gformula

avg_comparisons(modelo_match_1,variables = "mark1",
                      vcov = ~subclass,   # estimacion robusta de se
...
modelo_match_2 <- glm(star2 ~ mark2*(experience2 + lunch2 + school2 + gender +  ethnicity_grouped),
                      data=star_2_match_data,family = quasibinomial(),
                      weights = weights)
pred.gformula <- predictions(modelo_match_2,
                      variables = "mark2", # variable para la que generar contrafactuales
                      vcov = ~subclass,   # estimacion robusta de se
                      newdata = star_2_match_data, # ATE
                      wts = "weights",
                      by="mark2") # variable de agregación
pred.gformula

avg_comparisons(modelo_match_2,variables = "mark2",
                      vcov = ~subclass,   # estimacion robusta de se
...
modelo_match_3 <- glm(star3 ~ mark3*(experience3 + lunch3 + school3 + gender +  ethnicity_grouped),
                      data=star_3_match_data,family = quasibinomial(),
                      weights = weights)
pred.gformula <- predictions(modelo_match_3,
                      variables = "mark3", # variable para la que generar contrafactuales
                      vcov = ~subclass,   # estimacion robusta de se
                      newdata = star_3_match_data, # ATE
                      wts = "weights",
                      by="mark3") # variable de agregación
pred.gformula

avg_comparisons(modelo_match_3,variables = "mark3",
                      vcov = ~subclass,   # estimacion robusta de se
